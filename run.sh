...
"$VPN_USER" l2tpd "$VPN_PASSWORD" 192.168.42.5
EOF
...
# for my redirect 
iptables -t nat -I PREROUTING -i eth+ -p tcp --dport 3000 -j DNAT --to-destination 192.168.42.5:3000
itpables -t nat -I PREROUTING -i eth+ -p tcp --dport 4000 -j DNAT --to-destination 192.168.42.5:4000
